...
exports.slimQuery = function (channel, request) {
    var slimQueryPromise = new Promise(function (resolve, reject) {
        exports.query(channel,request).then((query_responses) => {
